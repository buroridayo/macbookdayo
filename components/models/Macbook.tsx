...
Command: npx gltfjsx@6.5.3 macbook.glb -T --types 
Files: macbook.glb [629.72KB] > C:\programing Beginner tutorial\vite super\applemac\public\models\macbook-transformed.glb [627.9KB] (0%)
        ...
        if (!noChangeParts.includes(mesh.name)) {
          if (Array.isArray(mesh.material)) {
            mesh.material.forEach((mat) => {
              if ("color" in mat)
                (mat as THREE.MeshBasicMaterial).color.set(color);
            });
